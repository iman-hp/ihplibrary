...
public class My_TextView_Fa extends AppCompatTextView {
    Context context;

    public My_TextView_Fa(Context context) {
    ...
    public My_TextView_Fa(Context context, AttributeSet attrs) {
        super(context, attrs);
        setPersianInteger();
        setLetterSpacing();
        setFont(context);
    ...
    public My_TextView_Fa(Context context, AttributeSet attrs, int defStyleAttr) {
